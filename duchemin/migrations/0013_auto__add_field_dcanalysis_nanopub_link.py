...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DCAnalysis.nanopub_link'
        db.add_column(u'duchemin_dcanalysis', 'nanopub_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DCAnalysis.nanopub_link'
        db.delete_column(u'duchemin_dcanalysis', 'nanopub_link')
    ...
    models = {
        ...
        'duchemin.dcanalysis': {
            'Meta': {'ordering': "['phrase_number__phrase_num', 'start_measure']", 'object_name': 'DCAnalysis'},
            ...
            'composition_number': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'analyses'", 'to_field': "'piece_id'", 'to': "orm['duchemin.DCPiece']"}),
            'earlier_phrase': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_cadence': ('django.db.models.fields.BooleanField', [], {}),
            'nanopub_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'phrase_number': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'analyses'", 'to_field': "'phrase_id'", 'to': "orm['duchemin.DCPhrase']"}),
        ...
        'duchemin.dcbook': {
            'Meta': {'ordering': "['id']", 'object_name': 'DCBook'},
        ...
        'duchemin.dccomment': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'DCComment'},
        ...
        'duchemin.dcphrase': {
            ...
            'piece_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'phrases'", 'to_field': "'piece_id'", 'to': "orm['duchemin.DCPiece']"}),
            'rhyme': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        'duchemin.dcpiece': {
            'Meta': {'ordering': "['piece_id']", 'object_name': 'DCPiece'},
            'audio_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'book_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pieces'", 'to_field': "'book_id'", 'to': "orm['duchemin.DCBook']"}),
